...
abstract class AppLocalizations {
  ...
  /// No description provided for @authDontHaveAccountRegister.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @userFname.
  ///
  /// In en, this message translates to:
  /// **'First Name'**
  String get userFname;

  /// No description provided for @userLname.
  ///
  /// In en, this message translates to:
  /// **'Last Name'**
  String get userLname;
  ...
  /// No description provided for @userBdate.
  ///
  /// In en, this message translates to:
  /// **'Birth Date'**
  String get userBdate;
